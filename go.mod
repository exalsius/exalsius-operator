...
require (
	...
	github.com/k0sproject/k0smotron v1.4.2
...
require (
	...
	github.com/projectsveltos/addon-controller v0.52.2 // indirect
	github.com/projectsveltos/libsveltos v0.52.2 // indirect
